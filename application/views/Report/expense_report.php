            ...
            <div class="card card-default">
              ...
              <form role="form" method="post" autocomplete="off">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-4 offset-md-2">
                    <select class="form-control select2 form-control-sm" name="expense_type_id" id="expense_type_id" data-placeholder="Select Expense Type" title="Select Expense Type">
                      <option selected="selected" value="">Select Expense Type</option>
                      <?php if(isset($expense_type)){
                        foreach ($expense_type as $list) { ?>
                        <option value="<?php echo $list->expense_type_id; ?>"><?php echo $list->expense_type_name; ?></option>
                      <?php } } ?>
                    </select>
                  </div>
                    ...
                    <div class="col-12 table-responsive">
                      <table class="table table-botttom" id="exp_tbl1"  width="100%">
                        ...
                        <thead>
                          ...
                          <th> <p style="text-align:center">Exp. VCH. No.</p> </th>
                        ...
                        <tbody>
                          <?php $i = 0;
                          foreach ($expense_report as $details) {
                            $i++;
                            $addedby = $details->expense_addedby;
                            $user_data = $this->User_Model->get_info_array('user_id', $addedby, 'user')
                          ?>
                            <tr>
                              <td> <p style="text-align:center"><?php echo $i; ?></p></td>
                              <td> <p style="text-align:center"><?php echo $details->expense_vc_no; ?></p></td>
                              <td> <p style="text-align:center"><?php echo $details->expense_date; ?></p></td>
                              <td> <p style="text-align:center">&#8377; <?php echo $details->expense_amount; ?></p></td>
                              <td> <p style="text-align:center"><?php echo $details->expense_notes; ?></p></td>
