        ...
        <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>User/expenses_list" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>User/purchase_list" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>User/bill_cycle_list" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>User/bill_list" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>User/receipt_list" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                   Receipt
                    </p>
