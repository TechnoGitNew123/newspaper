              ...
              <form role="form">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-12">
                    <input type="text" class="form-control" name="" id="" placeholder="Enter Name of Customer">
                  </div>
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control" name="" id="" placeholder="Whatsup No. 2">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="email" class="form-control" name="" id="" placeholder="Email">
                  </div>
                  <div class="form-group col-md-4">
                    <input type="text" class="form-control" name="" id="" placeholder="Biil Send type">
                  </div>
