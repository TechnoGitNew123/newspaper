              ...
              <form role="form">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control"  name="" id="" title="Expenses VCH. No." placeholder="Expenses VCH. No.">
                  </div>
                  ...
                  <div class="form-group col-md-12">
                    <select class="form-control select2 form-control-sm" title="Select Expenses Type" style="width: 100%;">
                  ...
                  <div class="form-group col-md-12">
                    <textarea class="form-control" rows="3" name="" id="" placeholder="Additional Notes"></textarea>
                  </div>
                </div>
