          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"> Paper Information</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control"  name="" id="" title="Start Date" placeholder="Start Date">
                  </div>
                 ...
                 <button id="add_row" class="btn btn-sm btn-primary mb-3 mr-1" width="150px">Add Row</button>
                  ...
                  <div class="form-group col-md-12">
                  <label for="" >Scheme Section : </label>
                  </div>
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control"  name="" id="" title="End Date" placeholder="End Date">
                  </div>
