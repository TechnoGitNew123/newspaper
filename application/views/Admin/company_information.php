              ...
              <div class="card-body row">
                ...
                <div class="form-group col-md-6">
                  <select class="form-control" name="company_status" id="company_status">
                    <option <?php if(isset($company_status) && $company_status == 'Active'){ echo 'selected'; } ?>>Active</option>
                    <option <?php if(isset($company_status) && $company_status == 'Inactive'){ echo 'selected'; } ?>>Inactive</option>
                  </select>
                </div>
              </div>
                <!-- /.card-body -->
